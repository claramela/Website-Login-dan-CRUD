				...
				<div class="col-lg-12">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a onclick="return confirm('Apakah kamu yakin data akan di hapus?')" href="proses/crud.php?aksi=hapus&hapusid=<?php echo $isi['id_login'];?>" 
                    ...
                    <?php }else{?>
                        ...
                        <div class="alert alert-info">
                           <br> <h2> <p style="text-align:center">Hallo Everyone, Welcome to My Website🙌🏻</p></h2></br>
                           <p style="text-align:center"> <h4>Di dalam website ini kamu bisa membuat, mengubah, menghapus data</h4></p>
                                <h4>Untuk Dapat Mengakses CRUD</h4>
                                <p style="text-align:center"> <h4>Silahkan Kalian Login Terlebih Dahulu!</p>
                                <p><a href="login.php"><h6>Klik Disini untuk Login</a></h6>
                            <br>
                        </div>
                    <?php }?>
			    </div>
